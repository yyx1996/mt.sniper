...
def GInput():
    ...
    x = task.createAlg("PackIndexAlg")
    x.property("IndexFile").set("/sharefs/bes/zoujh/juno/MtAna/index.txt")
    x.property("DataFiles").set(["/sharefs/bes/zoujh/juno/MtAna/0.5M_OEC.root"])
    x.property("TimeWindow").set([-0.1, 0.1]);
    #x.setLogLevel(2)
